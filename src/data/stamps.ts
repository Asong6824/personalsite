...
export const stations: StationInfo[] = [
  ...
  },
  {
    ...
    railDiagram: {
      ...
      nodes: [
        { label: "名古屋・東京", x: 198, y: 16, role: "direction" },
        { label: "京都", stationId: "kyoto", x: 158, y: 48, role: "collected" },
        { label: "新大阪", stationId: "shin-osaka", x: 105, y: 100, role: "current" },
        { label: "大阪", x: 111, y: 133, role: "direction" },
        { label: "広島", stationId: "hiroshima", x: 49, y: 119, role: "collected" },
        { label: "博多", stationId: "hakata", x: 18, y: 134, role: "collected" },
        { label: "御堂筋", x: 61, y: 83, role: "direction" },
      ],
    },
  },
  {
