...
export default function ObserveSignalField() {
  return (
    ...
    >
      ...
      <div className="observe-signal-core absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md border border-[#8a4ec7]/35 bg-[#f5efff]/70 px-3 py-1.5 text-sm font-medium text-[#8a4ec7] opacity-0 shadow-sm backdrop-blur-sm">
        submitted_image_pool
      </div>
